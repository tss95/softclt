...
if __name__ == '__main__':
    ...
    parser.add_argument('dataset', default="Cricket", help='The dataset name')
    parser.add_argument('--loader', type=str, default="UEA", required=False, help='The data loader used to load the experimental data. This can be set to UCR, UEA, forecast_csv, forecast_csv_univar, anomaly, or anomaly_coldstart')
